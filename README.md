...
# Clone Repository
Clone justcloudnative/argocd-manages-itself repository to your local device.
```
git clone https://github.com/justcloudnative/argocd-manages-itself.git
```
...
server:
  ...
  config:
    repositories: |
      - type: git
        url: https://github.com/justcloudnative/argocd-manages-itself.git
      - name: argo-helm
        type: helm
  ...
  additionalApplications: 
    - name: argocd
      ...
      source:
        ...
        repoURL: https://github.com/justcloudnative/argocd-manages-itself.git
        targetRevision: HEAD
      syncPolicy:
        syncOptions:
